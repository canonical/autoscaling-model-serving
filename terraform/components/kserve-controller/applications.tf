...
# KServe Controller application. In standard (RawDeployment) mode it does not
# require Knative; it consumes an ingress gateway either via ingress-gateway
# (istio sidecar) or gateway-metadata (Envoy / ambient Istio).
